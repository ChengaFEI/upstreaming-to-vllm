...
LOCAL_MODEL_PATH = "/home/ubuntu/.cache/huggingface/hub/models--mistralai--Pixtral-Large-Instruct-2411/snapshots/8f57ad2469ff52595e776d6717155492bf7f4830"
...
def get_prompt():
            ...
            "content": [
                {
                    ...
                    "text": "Which of the depicted countries has the best food?",
                },
    ...
    tokenizer = MistralTokenizer.from_pretrained(LOCAL_MODEL_PATH, revision=None)
...
def main():
    ...
    llm = LLM(
        ...
        override_neuron_config={
            ...
            "context_encoding_buckets": [MAX_SEQUENCE_LENGTH],
            "token_generation_buckets": [MAX_SEQUENCE_LENGTH],
        },
    )
